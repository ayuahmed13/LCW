...
if ($(".tf-sw-recent").length > 0) {
  ...
  autoplay: {
    delay: 3000, // Adjust delay as needed (in ms)
    disableOnInteraction: false,
  },
  navigation: {
    clickable: true,
...
// if ($(".tf-sw-testimonial-icon").length > 0) {
 
//   var swiper = new Swiper(".tf-sw-testimonial-icon", {
//     slidesPerView: 2,
//     spaceBetween: 5,
//     speed: 1000,
//     pagination: {
...
if ($(".tf-sw-testimonial-icon").length > 0) {
  var swiper = new Swiper(".tf-sw-testimonial-icon", {
    ...
    // REMOVE pagination dots by commenting/removing this block
    // pagination: {
    //   el: ".sw-pagination-testimonial",
    //   clickable: true,
    // },
