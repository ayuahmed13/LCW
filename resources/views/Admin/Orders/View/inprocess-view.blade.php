                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 bg-white box-body" style="min-height: 310px;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="basic-strip c-strip inprocess-bg">Status -
                                            Inprocess
                                        </div>
                                        <div class="print-btn">
                                ...
                                <div class="col-md-12 bg-white py-1">
                                    <div class="row">
                                        ...
                                        <div class="mb-2 col-md-4">
                                            ...
                                            <p class="mb-0  form-label">DTDC Courier Services</p>
                                        </div>
                                        <div class="mb-2 col-md-4">
                                        ...
                                        <div class="mb-2 col-md-12">
                                            ...
                                            <p class="mb-0  form-label">dtdc.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
