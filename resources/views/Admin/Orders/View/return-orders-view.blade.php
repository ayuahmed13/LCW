                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 bg-white box-body" style="min-height: 310px;">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="basic-strip c-strip cancelled-bg">Status -
                                            Return
                                        </div>
                                        <div class="print-btn">
                                    ...
                                    <div class="col-md-12 bg-white py-1">
                                        <div class="row">
                                            ...
                                            <div class="mb-2 col-md-4">
                                                <label class="mb-0 d-block">Order Return Date & Time</label>
                                                <p class="mb-0 form-label">2025-05-10 , 14:30</p>
                                            </div>
                                    
                                            <!-- Remark -->
                                            <div class="mb-2 col-md-12">
                                                <label class="mb-0 d-block">Remark</label>
                                                <p class="mb-0 form-label">Unable to Reach.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    {{-- <div class="card mt-3">
                        <div class="col-md-4  my-2">
                            ...
                            <select class="form-select" id="statusSelect" onchange="toggleRemark()">
                        ...
                        <div class="col-md-8 mb-2" id="remarkSection" style="display: none; margin-top: 10px;">
                            ...
                            <textarea class="form-control" placeholder="Enter your remark..." rows="5"></textarea>
                        </div>
...
@section('script')
<script>
    $(".return-orders").addClass("menuitem-active");
    $(".return-orders a").addClass("active");
</script>
