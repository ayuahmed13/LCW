            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 justify-content-between d-flex align-items-center">
                        <h4 class="mt-0 header-title">Completed Order List</h4>
                        <div>
                            ...
                            <a href="{{ url('/admin/delievered') }}" class="btn btn-success waves-effect waves-light add-btn"><span class="btn-label"> <i class="fas fa-check-circle"></i></span>Delievered</a>
