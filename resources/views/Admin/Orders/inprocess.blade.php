            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 justify-content-between d-flex align-items-center">
                        <h4 class="mt-0 header-title">InProcess Order List</h4>
                        <div>
                            ...
                            <a href="{{ url('/admin/inprocess') }}" class="btn btn-info  waves-effect waves-light add-btn"><span class="btn-label"> <i class="mdi mdi-progress-clock"></i></span>Inprocess</a>
