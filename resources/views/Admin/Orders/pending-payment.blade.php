            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 justify-content-between d-flex align-items-center">
                        <h4 class="mt-0 header-title">Pending Payment List</h4>
                        <div>
							<a href="{{ url('/admin/pending-payment') }}"" class="btn btn-info waves-effect waves-light add-btn"><span class="btn-label"> <i class="fas fa-clock"></i></span> Payment Pending</a>
                            ...
                            <a href="{{ url('/admin/cancelled') }}" class="btn btn-outline-danger waves-effect waves-light add-btn"><span class="btn-label"> <i class="mdi mdi-close-circle"></i></span>Cancelled</a>
                        </div>
                    </div>
