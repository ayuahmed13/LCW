            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 justify-content-between d-flex align-items-center">
                        <h4 class="mt-0 header-title">Confirmed Order List</h4>
                        <div>
                            ...
                            <a href="{{ url('/admin/confirmed') }}" class="btn btn-success waves-effect waves-light add-btn"><span class="btn-label"> <i class="mdi mdi-check-decagram"></i></span>Confirmed</a>
