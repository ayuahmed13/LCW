...
<div class="content-page">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 justify-content-between d-flex align-items-center">
                        <h4 class="header-title ">{{!empty($edit_data)?'Edit':'Add'}} City/Suburb</h4>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card department-card">
                        <div class="card-body">
                            ...
                            <form id="cityForm" name="cityForm" action="{{url('admin/city-master/store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-12">
                                        ...
                                        <input type="text" class="form-control" name="city_name" id="city_name" placeholder="Enter City" value="{{!empty($edit_data->city_name) ? $edit_data->city_name : ''}}" onkeypress="return /[A-Z a-z]/i.test(event.key)">
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(".city").addClass("menuitem-active");
        $(".city a").addClass("active");
    </script>
    <script src="{{ asset('controller_js/cn_city_master.js') }}"></script>
    @endsection